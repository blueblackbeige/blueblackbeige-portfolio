  ...
  return (
    <section id="work" className="relative py-24 lg:py-32">
      ...
      <div className="max-w-[1440px] mx-auto section-padding">
        ...
        <ScrollReveal>
          <div className="relative rounded-2xl overflow-hidden border border-white/[0.06] bg-bg-secondary/20 mb-5" style={{ aspectRatio: "16/7" }}>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-8">
              {/* Coming soon pill */}
              <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-accent-blue/25 bg-accent-blue/[0.06] mb-8">
                <span className="w-1.5 h-1.5 rounded-full bg-accent-blue animate-glow-pulse" />
                <span className="text-[10px] tracking-[0.3em] text-accent-blue font-semibold uppercase">
                  Case studies coming soon
                </span>
              </div>

              <h3 className="text-3xl sm:text-5xl lg:text-6xl font-serif font-medium text-white/80 mb-4 leading-tight">
                Our work speaks
                <br />
                for itself<span className="text-accent-blue">.</span>
              </h3>
              <p className="text-text-secondary/60 text-sm lg:text-base max-w-md leading-relaxed mb-8">
              ...
              <a
                href="#contact"
                className="group inline-flex items-center gap-2 px-6 py-3 border border-white/15 rounded-full text-sm font-medium text-white hover:border-white/30 hover:bg-white/5 transition-all duration-300"
              >
                Request Portfolio
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </a>
          ...
          {placeholders.map((p, i) => (
            <ScrollReveal key={p.number} delay={i * 0.08}>
              <div>
                ...
                <div className="flex items-center gap-6 lg:gap-10 py-6 lg:py-7">
                  {/* Number */}
                  ...
                  <div className="w-16 h-12 lg:w-20 lg:h-14 rounded-lg flex-shrink-0 bg-white/[0.03] border border-white/[0.04] flex items-center justify-center">
                    <span className="text-[8px] tracking-[0.2em] text-white/15 uppercase font-sans">Soon</span>
                  </div>

                  {/* Name placeholder */}
                  <div className="flex-1 min-w-0">
                    <div className="h-4 w-36 rounded bg-white/[0.04] mb-2" />
                    <div className="h-2.5 w-52 rounded bg-white/[0.025]" />
                  </div>
                  ...
                  {/* Coming soon badge */}
                  <div className="flex-shrink-0 px-3 py-1 rounded-full border border-white/[0.06] bg-white/[0.02]">
