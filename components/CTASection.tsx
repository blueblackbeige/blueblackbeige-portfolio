    ...
    <section id="contact" className="relative py-20 lg:py-36 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto section-padding">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-24 items-start">
          ...
          {/* Right: Contact Form */}
          <ScrollReveal delay={0.2}>
            <div className="luxury-border rounded-2xl p-8 lg:p-12 bg-bg-secondary/30 backdrop-blur-sm h-full flex flex-col items-center justify-center text-center min-h-[320px] lg:min-h-[400px]">
              <div className="w-14 h-14 lg:w-16 lg:h-16 rounded-full bg-[#25D366]/10 flex items-center justify-center mb-5 lg:mb-6">
                <svg className="w-7 h-7 lg:w-8 lg:h-8 text-[#25D366]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl lg:text-2xl font-serif font-medium text-white mb-3 lg:mb-4">
                Let&apos;s chat on WhatsApp
              </h3>
              <p className="text-sm text-text-secondary mb-6 lg:mb-8 max-w-sm">
